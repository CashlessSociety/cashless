...
cashlessAddress = network => {
	...
	if (network == "ropsten") {
		return "0x1FCaA3995e470BBb4F36EcDBFcC1831A8d04Efc4";
	}
	if (network == "dev") {
...
cashlessLibAddress = network => {
	...
	if (network == "ropsten") {
		return "0xEC5673a97E50E4e0220A52A0E6C74262409C7E60";
	}
	if (network == "dev") {
...
erc20Address = network => {
    ...
    if (network == "ropsten") {
        return "0x4FB165bdf18347Ba304597951D903A7cd2DaFF6C";
    }
    if (network == "dev") {
